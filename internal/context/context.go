...
func NewAppCtx(logger *logging.LoggerWrapper, validator *validate.Validator, client *httpclient.HttpClient, userServiceURL string, jwtConfig config.JwtTokenConfig, domainName string, pm password.PasswordManager, idGeneratorService *snowflake.IdGeneratorService) *AppContext {
	return &AppContext{
