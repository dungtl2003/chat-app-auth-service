...
TOKEN_ISSUER=${TOKEN_ISSUER:-"chat-app"}
TOKEN_INTERNAL_AUDIENCE=${TOKEN_INTERNAL_AUDIENCE:-"chat-app-internal"}
TOKEN_FRONTEND_AUDIENCE=${TOKEN_FRONTEND_AUDIENCE:-"chat-app-frontend"}
...
SMTP_EMAIL_FROM_ADDRESS="${SMTP_EMAIL_FROM_NAME_DISPLAY:-fake\@gmail.com}"
...
PASSWORD_RESET_ATTEMPT_TTL="${PASSWORD_RESET_ATTEMPT_TTL:-1h}"
PASSWORD_RESET_ATTEMPT_MAX="${PASSWORD_RESET_ATTEMPT_MAX:-5}"
